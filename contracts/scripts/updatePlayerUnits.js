...
async function main() {
  ...
  await arena
    .connect(signers[0])
    .updateAdjustmentUnits([
      [
        "0x104D64F611aaA3F06F417F8D44F85A76FB44FbE9".toLowerCase(),
        "1000000",
        true,
      ],
      [
        "0x55557C4C2c9515d339a1f8136f9b67537ffE3333".toLowerCase(),
        "1000000",
        false,
      ],
    ])
    .then(function (tx) {
      console.log(`
        Congrats! You've just successfully updated units. 
        Tx Hash: ${tx.hash}
    `);
    });
}
